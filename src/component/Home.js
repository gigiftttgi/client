...
function Home() {
  return (
    <div>
      ...
      <Container>
        <h3>
          Participating in plays in your college campus can help you meet new
          people and develop new skills (like sewing costumes or building sets).
          Dance teams, orchestras, choruses, and other performing arts societies
          are also available.
        </h3>
      </Container>
      <Container>
        <h3>
          College club activities can give a résumé more individuality and
